...
export const themeName = 'Professional Healthcare Practice'
export const themeDescription = 'Trustworthy, calming design for medical practices and healthcare providers'
