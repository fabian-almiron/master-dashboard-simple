      ...
      <div className="theme-container">
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-theme-gray-900">Compassionate Care You Can Trust</h1>
            <p className="mx-auto max-w-[700px] text-theme-gray-600 md:text-xl leading-relaxed">Providing comprehensive healthcare services with a personal touch. Your well-being is our commitment.</p>
          </div>
