      ...
      <div className="theme-container">
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-theme-gray-900">Scale Your Business with Smart SaaS Solutions</h1>
            <p className="mx-auto max-w-[700px] text-theme-gray-600 md:text-xl leading-relaxed">Transform your operations with our cutting-edge platform that grows with your ambitions. Join thousands of companies already scaling with confidence.</p>
          </div>
