        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-theme-gray-900">
              ...
              <span className="block text-theme-primary-600">With Base Theme</span>
            </h1>
            <p className="mx-auto max-w-[700px] text-theme-gray-600 md:text-xl leading-relaxed">
              A clean and modern theme designed for performance, accessibility, and ease of use. 
              Perfect for businesses, portfolios, and content-focused websites.
            </p>
          </div>
